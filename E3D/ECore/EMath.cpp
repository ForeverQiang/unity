...
namespace E3D
{
	...
	void GetRotateMatrix44(EMatrix44 & mat, const EVector4D & normal, EFloat degree)
	{
		...
		mat.m[0][0] = normal.x * normal.x + oneCosA + cosA, mat.m[0][1] = normal.x * normal.y * oneCosA + normal.x * sinA, 
			mat.m[0][2] = normal.x * normal.z * oneCosA -normal.y * sinA, mat.m[0][3] = 0;

		mat.m[1][0] = normal.x * normal.y * oneCosA - normal.z * sinA, mat.m[1][1] = normal.y * normal.y * oneCosA + cosA, 
			mat.m[1][2] = normal.y*normal.z*oneCosA + normal.x  * sinA, mat.m[1][3] = 0;

		mat.m[2][0] = normal.x * normal.z * oneCosA + normal.y * sinA, mat.m[2][1] = normal.y * normal.z * oneCosA -normal.x * sinA,
			mat.m[2][2] = normal.z * normal.z * oneCosA + cosA, mat.m[2][3] = 0;
