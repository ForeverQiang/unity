...
namespace E3D
{
	...
	struct EMatrix44
	{
			...
			EFloat m3_0, EFloat m3_1, EFloat m3_2, EFloat m3_3)
		{
			...
			m[1][0] = m1_0, m[1][1] = m1_1, m[1][2] = m1_2, m[0][3] = m1_3;
			m[2][0] = m2_0, m[2][1] = m2_1, m[2][2] = m2_2, m[0][3] = m2_3;
			m[3][0] = m3_0, m[3][1] = m3_1, m[3][2] = m3_2, m[0][3] = m3_3;
		}
		//矩阵转置
		...
		//获取矩阵中的某个值
		inline EFloat ar(size_t i, size_t j) const
		{
			return m[i][j];
		}
		//获取矩阵中的某个值
