...
namespace E3D
{
	EMesh::EMesh() : mObject(NULL), mSubmeshNumber(1), mCollsionType(COLLSION_COLLSION), mPolyonNumber(0), mVertexNumber(0), mRotate(0, 0, 0), mIsVisible(true) 
	{

	}
	EMesh::EMesh(const EString & name, const EString & meshName) : mSubmeshNumber(0), mPolyonNumber(0), mVertexNumber(0), mRotate(0, 0, 0), mCollsionType(COLLSION_COLLSION), mIsVisible(true)
	{
		mName = name;
